...
//		setLocation(((screenSize.height/2)-(windowSize.height/2)), ((screenSize.width/2)-(windowSize.width/2)));
		setLookAndFeel();
		...
		//TODO -- use core to import list of tickets on selected project from 'choice' possibly with Hashmaps
		List list = new List();
		for (int i = 0; i<10; i++)
		{
			list.add("" + i);
